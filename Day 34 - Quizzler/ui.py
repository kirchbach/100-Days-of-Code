...
class QuizInterface:
    def __init__(self, quiz_brain: QuizBrain):
        ...
        self.truebutton = Button(image=self.true_image, highlightthickness=0, command=self.check_if_true)
        self.truebutton.grid(column=0, row=2)
        self.false_image = PhotoImage(file="images/false.png")
        self.falsebutton = Button(image=self.false_image, highlightthickness=0, command=self.check_if_wrong)
